...
var (
	...
	ErrFileChooser                 = errors.New("error selecting file")
	ErrFileMigratorDirectory       = errors.New("selected item is a directory")
	ErrFileMigratorFile            = errors.New("selected item is a file")
)
